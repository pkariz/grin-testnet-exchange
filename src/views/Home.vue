<template>
  <v-container style="margin-top: 20px;">
      ...
      <v-card class="my-4">
        ...
        <v-card-text>
          <strong>Step1:</strong>
          <p>Insert the amount and your wallet address. The amount should be in Grin and <strong>not NanoGrin</strong> (use dot for decimals). You can get your wallet address by running: <code>./grin-wallet --testnet address</code>. Example of a wallet address: <code>tgrin1vsdvjhyv2rqnc8pw0g9d7atx8z32uq52r6vjk9tlh6tmkfxl8zksg7u4ut</code>. After you're done with this step click continue.</p>
          <strong>Step2:</strong>
          <p>Here you get the overall transaction info. Click on <code>Copy contract</code> (this copies an encrypted slatepack for your wallet) then run command <code>./grin-wallet --testnet contract sign --receive=30 --no-payjoin</code>. Remove the <code>--no-payjoin</code> flag if you want to payjoin as a receiver. After you execute the contract sign command, you will need to paste the slatepack. The command will give you a new slatepack that contains your signature which you should copy. Then click in the field below and paste the copied slatepack. After that, you will get a message that the transaction has been broadcasted and you will need to wait for the confirmations. Until it gets 3 confirmations this amount will be locked.</p>
        </v-card-text>
      </v-card>
  </v-container>
</template>
